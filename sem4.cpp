...
unordered_map<string, int> dm;     //city vs node delhi
unordered_map<string, int> ukm;    //city vs node uttrakhand
unordered_map<string, int> bangm;  //city vs node bangalore
unordered_map<int, string> dm1;    //node vs city delhi
unordered_map<int, string> ukm1;   //node vs city uttrakhand
unordered_map<int, string> bangm1; //node vs city bangalore
...
{
    // making driver for banglore map
...
void printAllPaths(int s, int d, vector<vector<edge>> &city, unordered_map<int, string> &getcity)
{
    ...
    printAllPathsUtil(s, d, city, visited, psf, getcity, count, distance);   //DFS
}
...
// find shortest path for city tour
// prims algorithm
...
void printMessageCenter(const char *message)
{
    ...
    cout << "\n\n\t\t       1. SAMBHAV GUPTA        - B6 - 22103181";
    cout << "\n\n\t\t       2. AMULAYA AGARWAL      - B6 - 22103165";
    cout << "\n\n\t\t       3. SRAJAN RASTOGI       - B6 - 22103153";
    cout << "\n\n\t\t       4. PARTH PRADHAN        - B6 - 22103154\n";
}
